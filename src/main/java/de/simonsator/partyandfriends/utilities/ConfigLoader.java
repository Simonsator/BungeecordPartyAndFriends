...
public class ConfigLoader extends ConfigurationCreator {
	...
	private void loadDefaultValues() {
		...
		set("Commands.Friends.SubCommands.Settings.Settings.FriendRequest.Names", "friendrequest", "receivefriendrequests");
		...
		set("Commands.Friends.SubCommands.Settings.Settings.PM.Names", "pm", "message");
