...
public class MSG extends Command {
	...
	public void deliverOfflineMessage(String pContent, OnlinePAFPlayer pWrittenTo, PAFPlayer pSender) {
		sendMessage(
				SPACEPATTERN.matcher(pContent)
						.replaceAll(Matcher.quoteReplacement(
								getInstance().getMessagesYml().getString("Friends.Command.MSG.ColorOfMessage"))),
	...
	private void sendMessage(String pContent, OnlinePAFPlayer pReceiver, String pSenderName, String pReceiverName) {
		pReceiver
				.sendMessage(new TextComponent(getInstance().getFriendsPrefix() + CONTENTPATTERN
						.matcher(PLAYERPATTERN
								.matcher(SENDERNAMEPATTERN
										.matcher(getInstance().getMessagesYml()
												.getString("Friends.Command.MSG.SendedMessage"))
										.replaceAll(Matcher.quoteReplacement(pSenderName)))
								.replaceAll(Matcher.quoteReplacement(pReceiverName)))
