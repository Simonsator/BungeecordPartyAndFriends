...
## Create your own extension using Party and Friends' api

You may create your own extension using Party and Friends' very extensive api. A detailed tutorial to get started can be found in the [the procects wiki](https://github.com/Simonsator/BungeecordPartyAndFriends/wiki/API).
