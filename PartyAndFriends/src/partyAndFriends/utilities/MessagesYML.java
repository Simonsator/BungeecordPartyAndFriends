...
public class MessagesYML {
	...
	public static Configuration ladeMessages() throws IOException {
		...
		File file = new File(Main.main.getDataFolder().getPath(), "Messages.yml");
		if (!file.exists()) {
			file.createNewFile();
		}
		...
		if (messagesYml.getString("Party.Command.General.ServerSwitched").equals("")) {
			messagesYml.set("Party.Command.General.ServerSwitched",
					"§bThe §bparty §bhas §bjoinend §bthe §bServer §e[SERVER]§b.");
		}
		...
		if (messagesYml.getString("Party.Command.Join.ErrorNoInvatation").equals("")) {
			messagesYml.set("Party.Command.Join.ErrorNoInvatation", "§cYou §can´t §cjoin §cthis §cparty.");
		}
		...
		if (messagesYml.getString("Friends.General.DoesntExist").equals("")) {
			messagesYml.set("Friends.General.DoesntExist", "§7");
		}
		...
		if (messagesYml.getString("Friends.Command.Accept.ErrorNoFriendShipInvitation").equals("")) {
			messagesYml.set("Friends.Command.Accept.ErrorNoFriendShipInvitation",
					" §7You didn´t recive a §7friend §7request §7from §e[PLAYER]§7.");
		}
		if (messagesYml.getString("Friends.Command.Accept.ErrorSenderEqualReciver").equals("")) {
			messagesYml.set("Friends.Command.Accept.ErrorSenderEqualReciver",
					" §7You can §7not §7write §7to §7yourself.");
		}
		if (messagesYml.getString("Friends.Command.Add.ErrorAlreadySend").equals("")) {
			messagesYml.set("Friends.Command.Accept.ErrorAlreadySend",
					"§7 You already have send §7the §7player §e[PLAYER] §7a §7friend §7request.");
		}
		if (messagesYml.getString("Friends.Command.Add.SenderEqualsReciver").equals("")) {
			messagesYml.set("Friends.Command.Add.SenderEqualsReciver",
					" §7You §7can §7not §7send §7yourself §7a §7friend §7request.");
		}
		if (messagesYml.getString("Friends.Command.Add.FriendRequestFromReciver").equals("")) {
			messagesYml.set("Friends.Command.Add.FriendRequestFromReciver",
					" §7The player §e[PLAYER] §7has §7already §7send §7you §7a §7friend §7request.");
		}
		if (messagesYml.getString("Friends.Command.Add.FriendRequestRecived").equals("")) {
			messagesYml.set("Friends.Command.Add.FriendRequestRecived",
					"§7 You have recived a friend request from §e[PLAYER] §7.");
		}
		...
		if (messagesYml.getString("Friends.Command.Add.CanNotSendThisPlayer").equals("")) {
			messagesYml.set("Friends.Command.Add.CanNotSendThisPlayer",
					" §7You §7can §7not §7send §7the §7player §e[PLAYER] §7a §7friend §7request");
		}
		...
		if (messagesYml.getString("Friends.Command.Settings.NowYouAreNotGoneReciveFriendRequests").equals("")) {
			messagesYml.set("Friends.Command.Settings.NowYouAreNotGoneReciveFriendRequests",
					" §7Now §7you §7are §cnot §7gone §7recive §7friend §7requests §7anymore");
		}
		if (messagesYml.getString("Friends.Command.Settings.NowYouAreGoneReciveFriendRequests").equals("")) {
			messagesYml.set("Friends.Command.Settings.NowYouAreGoneReciveFriendRequests",
					" §7Now §7you §7are §agone §7recive §7friend §7requests §7from §7everyone");
		}
		if (messagesYml.getString("Friends.Command.Settings.NowYouAreNotGoneReciveMessages").equals("")) {
			messagesYml.set("Friends.Command.Settings.NowYouAreNotGoneReciveMessages",
		...
		if (messagesYml.getString("Friends.Command.Settings.AtTheMomentYouAreNotGoneReciveFriendRequests").equals("")) {
			messagesYml.set("Friends.Command.Settings.AtTheMomentYouAreNotGoneReciveFriendRequests",
					" §7At §7the moment §7you §7are §cnot §7gone §7recive §7friend §7request");
		}
		if (messagesYml.getString("Friends.Command.Settings.AtTheMomentYouAreGoneReciveFriendRequests").equals("")) {
		...
		if (messagesYml.getString("Friends.Command.Jump.CanNotJump").equals("")) {
			messagesYml.set("Friends.Command.Jump.CanNotJump", " §7You §7can §7not §jump to §7this §7person");
		}
		...
		if (messagesYml.getString("Friends.Command.List.OnlineTitle").equals("")) {
			messagesYml.set("Friends.Command.List.OnlineTitle", "(offline)");
		}
		...
		if (messagesYml.getString("Friends.Command.MSG.CanNotWriteToHim").equals("")) {
			messagesYml.set("Friends.Command.MSG.CanNotWriteToHim", " §7You can not write to this player.");
		}
